...
public class DragonBoatRace extends ApplicationAdapter {
	...
	public void create() {
		...
		for (int i = 0; i < 50; i++) {
			obs[i] = new Branch(-(1 + random.nextInt(4)), 0, 2, 1000 + random.nextInt(5340), 80 + random.nextInt(561),
					64, 16, 8, false, world, "sprites/branch.png");
		}

		// creation of late game obstacles
		for (int i = 0; i < 10; i++) {
			lateObs[i] = new Branch(-(1 + random.nextInt(4)), 0, 2, 4930 + random.nextInt(1410),

...
public class SelectScreen implements Screen {
    ...
    /**
     * Construct a boat selection screen
     * 
    ...
    public SelectScreen(DragonBoatRace dragonBoatRace) {
        ...
        blue.setPosition(Gdx.graphics.getWidth() / 6 - blue.getWidth() * 1.25f,
                Gdx.graphics.getHeight() * 2 / 3 - blue.getHeight() / 2);
        ...
        blueButton.setPosition(Gdx.graphics.getWidth() / 6 - blue.getWidth() * 1.3f,
                Gdx.graphics.getHeight() * 2 / 3 - blue.getHeight() * 8);
        ...
        green.setPosition((Gdx.graphics.getWidth() / 6) * 2 - green.getWidth() * 1.25f,
                Gdx.graphics.getHeight() * 2 / 3 - green.getHeight() / 2);
        ...
        greenStats.setPosition((Gdx.graphics.getWidth() / 6) * 2 - green.getWidth() * 1.55f,
                Gdx.graphics.getHeight() * 2.3f / 5);
        stage.addActor(greenStats);

        // Green Select Button
        TextButton greenButton = new TextButton("green", game.gameSkin);
        greenButton.setWidth(green.getWidth());
        greenButton.setPosition((Gdx.graphics.getWidth() / 6) * 2 - green.getWidth() * 1.3f,
                Gdx.graphics.getHeight() * 2 / 3 - green.getHeight() * 8);
        ...
        pink.setPosition((Gdx.graphics.getWidth() / 6) * 3 - pink.getWidth() * 1.25f,
                Gdx.graphics.getHeight() * 2 / 3 - pink.getHeight() / 2);
        ...
        pinkStats.setPosition((Gdx.graphics.getWidth() / 6) * 3 - pink.getWidth() * 1.25f,
        ...
        pinkButton.setPosition((Gdx.graphics.getWidth() / 6) * 3 - pink.getWidth() * 1.3f,
                Gdx.graphics.getHeight() * 2 / 3 - pink.getHeight() * 8);
        ...
        purple.setPosition((Gdx.graphics.getWidth() / 6) * 4 - purple.getWidth() * 1.25f,
                Gdx.graphics.getHeight() * 2 / 3 - purple.getHeight() / 2);
        ...
        purpleStats.setPosition((Gdx.graphics.getWidth() / 6) * 4 - purple.getWidth() * 1.5f,
                Gdx.graphics.getHeight() * 2.3f / 5);
        ...
        purpleButton.setPosition((Gdx.graphics.getWidth() / 6) * 4 - purple.getWidth() * 1.3f,
                Gdx.graphics.getHeight() * 2 / 3 - purple.getHeight() * 8);
        ...
        red.setPosition((Gdx.graphics.getWidth() / 6) * 5 - red.getWidth() * 1.25f,
                Gdx.graphics.getHeight() * 2 / 3 - red.getHeight() / 2);
        ...
        redStats.setPosition((Gdx.graphics.getWidth() / 6) * 5 - red.getWidth() * 1.275f,
                Gdx.graphics.getHeight() * 2 / 5);
        ...
        redButton.setPosition((Gdx.graphics.getWidth() / 6) * 5 - red.getWidth() * 1.3f,
                Gdx.graphics.getHeight() * 2 / 3 - red.getHeight() * 8);
        ...
        yellow.setPosition(Gdx.graphics.getWidth() - yellow.getWidth() * 1.25f,
                Gdx.graphics.getHeight() * 2 / 3 - yellow.getHeight() / 2);
        ...
        yellowStats.setPosition(Gdx.graphics.getWidth() - yellow.getWidth() * 1.59f,
                Gdx.graphics.getHeight() * 2.3f / 5);
        ...
        yellowButton.setPosition(Gdx.graphics.getWidth() - yellow.getWidth() * 1.3f,
                Gdx.graphics.getHeight() * 2 / 3 - yellow.getHeight() * 8);
